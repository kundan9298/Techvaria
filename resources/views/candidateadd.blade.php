...
<div class="container-fluid">
   ...
   <div class="row">
      <a href="{{url('candidate')}}"> <button type="button" class="btn btn-primary">Back</button></a>
      <div class="col-md-12">
         <div class="row">
...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="col-md-6">
        <div class="card p-4">
            <h5 class="text-center mb-4">{{isset($data) ? 'Update' : 'Add'}} Candidate</h5>
            <form action="{{isset($data) ? url('candidate/update/'.$data->id) : url('candidate/addData')}}" method="post">
                @csrf
                <div class="mb-3">
